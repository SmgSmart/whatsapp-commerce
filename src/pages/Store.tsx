...
export function Store() {
    ...
    if (!business) {
        return (
            <div className="min-h-screen flex items-center justify-center bg-brand-dark text-brand-header p-6 text-center">
                <div>
                    <h1 className="text-2xl font-bold font-display text-brand-header">Store Not Found</h1>
        ...
        return (
            <div className="min-h-screen flex items-center justify-center bg-brand-dark text-brand-header p-6 text-center">
                <div className="bg-brand-steel/10 border border-brand-steel/15 p-8 md:p-12 rounded-3xl max-w-lg w-full backdrop-blur-md shadow-xl">
                    ...
                    <h1 className="text-2xl font-bold font-display text-brand-header">Store Temporarily Unavailable</h1>
