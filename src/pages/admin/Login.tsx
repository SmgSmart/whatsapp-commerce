    ...
    return (
        <div className="min-h-screen bg-[#f8fafc] flex items-center justify-center p-4 font-sans">
            <div className="w-full max-w-md bg-white rounded-[24px] shadow-[0_20px_50px_rgba(0,0,0,0.05)] p-10 border border-gray-100">
                ...
                <form 
                    action="https://ep-divine-grass-aqm5ypmq.neonauth.c-8.us-east-1.aws.neon.tech/neondb/auth/sign-in/social" 
                    method="POST"
                    className="w-full"
                >
                    <input type="hidden" name="provider" value="google" />
                    <input type="hidden" name="callbackURL" value={window.location.origin + "/auth/success"} />
                    <button
                        type="submit"
